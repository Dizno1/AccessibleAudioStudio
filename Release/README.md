...
|---|---|---|
| `AccessibleAudioStudio Pro_0.1.3_x64_en-US.msi` | WiX (msi) target | Recommended installer -- standard Windows Installer package |
| `AccessibleAudioStudio Pro_0.1.3_x64-setup.exe` | NSIS target | Alternate installer -- setup executable |
