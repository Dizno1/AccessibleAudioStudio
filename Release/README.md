...
|---|---|---|
| `AccessibleAudioStudio Pro_0.2.0_x64_en-US.msi` | WiX (msi) target | Recommended installer -- standard Windows Installer package |
| `AccessibleAudioStudio Pro_0.2.0_x64-setup.exe` | NSIS target | Alternate installer -- setup executable |
