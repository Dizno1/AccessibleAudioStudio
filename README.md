...
- **Push a Pro version tag** (e.g. `git tag pro-v0.2.2 && git push origin pro-v0.2.2`) to build both installers and open a **draft** GitHub Release with them attached, ready to review and publish.
...
| Version | 1.0.0 | 0.2.2 (current test build — see "Pro version numbering" below) |
